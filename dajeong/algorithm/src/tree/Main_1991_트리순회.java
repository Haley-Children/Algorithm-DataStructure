...
public class Main_1991_트리순회 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        bsTree = new int[2][N+1]; // 정점별 왼쪽 자식, 오른쪽 자식 저장하는 배열 => 개인적인 생각) lc, rc 배열 따로 관리하는 것이 더 직관적일 수 있을 것 같다.
        for (int i = 0; i < N; i++) {
            ...
            if (lcChar != '.') lc = lcChar-'A'+1;
            char rcChar = st.nextToken().charAt(0);
            if (rcChar != '.') rc = rcChar-'A'+1;
...
//        for (int i = 0; i < 2; i++) {
//            System.out.print(Arrays.toString(bsTree[i])+"  ");
//            System.out.println();
//        }
